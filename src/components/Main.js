// mwh created this to test converting the html files in the public dir to React rather than static HTML files.  
...
<title>Play | SaaS-Based Admin UI</title>
<link
  rel="shortcut icon"
  href="/images/marketing/favicon.png"
  type="image/x-icon"
/>
<link rel="stylesheet" href="marketing/css/animate.css" />
<link rel="stylesheet" href="marketing/css/tailwind.css" />
{/* ==== WOW JS ==== */}
  ...
  <div className="container">
    <div className="flex -mx-4 items-center justify-between relative">
      <div className="px-4 w-60 max-w-full">
        <a href="main.html" className="navbar-logo w-full block py-5">
          <img
            src="images/marketing/logo/logo-white.svg"
            alt="logo"
  ...
  <div className="container">
    <div className="flex flex-wrap items-center -mx-4">
      ...
      "
        ...
        "
          >
            Don't build an Admin UI. Use ours. It's much more fun!
          </h1>
          <p
            className="
          text-base
        ...
        "
          >
            We can integrate directly into your application and manage your
            users, account feature access, and a whole lot more.
          </p>
          ...
          <div className="text-center wow fadeInUp" data-wow-delay=".3s">
            <img
              src="images/marketing/hero/brand.svg"
              alt="image"
              className="
            max-w-[250px]
            w-full
      ...
      <div className="w-full px-4">
        ...
        >
          <div className="mt-16">
            <img
              src="images/marketing/hero/hero-image-play.png"
              alt="hero"
  ...
  <div className="container">
    <div className="flex flex-wrap -mx-4">
      <div className="w-full px-4">
        ...
        "
          >
            We can manage your feature-based Admin user interface, with
            feature-rich components, configurable templates, high-quality
    ...
    <div className="flex flex-wrap -mx-4">
      <div className="w-full md:w-1/2 lg:w-1/4 px-4">
        ...
        "
          ...
          <h4 className="font-bold text-xl text-dark mb-3">Feature Rich</h4>
          <p className="text-body-color mb-8 lg:mb-11">
            Don't incrementally add components over time. Use what we've
            built!
          </p>
          <a
            href="javascript:void(0)"
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 px-4">
        ...
        "
          ...
          <p className="text-body-color mb-8 lg:mb-11">
            Ex: Offer one version for Free, and another for Premium. It's all
            there!
          </p>
          <a
            href="javascript:void(0)"
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 px-4">
        ...
        "
          ...
          <p className="text-body-color mb-8 lg:mb-11">
            Rounded corners, smooth transitions ...what more can you ask for?
          </p>
          <a
            href="javascript:void(0)"
            className="font-medium text-base text-body-color hover:text-primary"
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 px-4">
        ...
        "
          ...
          <h4 className="font-bold text-xl text-dark mb-3">Open-Source</h4>
          <p className="text-body-color mb-8 lg:mb-11">
            Want to iterate on what we've already built? Go for it!
          </p>
          <a
            href="javascript:void(0)"
            className="font-medium text-base text-body-color hover:text-primary"
      ...
      <div className="flex flex-wrap -mx-4">
        ...
        "
          ...
          "
            ...
            "
              >
                Brilliant Admin Toolkit to Build SaaS Faster.
              </h2>
              <p className="text-base text-body-color mb-9 leading-relaxed">
                You're focused on your core SaaS product. That's what you do!
                But now you have to manage the backend of that SaaS app, and
                it's getting complicated (feature gates, activations, etc).
              </p>
              <p className="text-base text-body-color mb-9 leading-relaxed">
                Focus on what you do best (your SaaS), and let us manage the
                complexities of feature activation. We're here to help.
              </p>
              <a
                href="javascript:void(0)"
                className="
            ...
            <div className="text-center">
              <div className="relative inline-block z-10">
                <img
                  src="images/marketing/about/about-image.svg"
                  alt="image"
  ...
  <div className="container">
    <div className="flex flex-wrap -mx-4">
      <div className="w-full px-4">
        ...
        "
          >
            We try to keep pricing simple. Three tiers, all shown below.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-wrap -mx-4">
        ...
        >
          ...
          <div className="faq-content pl-[62px] hidden">
            <p className="text-base text-body-color leading-relaxed py-3">
              It's easy! Just use the Table feature.
            </p>
          </div>
        </div>
        <div
      ...
      "
        >
          ...
          <div className="faq-content pl-[62px] hidden">
            <p className="text-base text-body-color leading-relaxed py-3">
              Yes, there's a built-in CRUD component.
            </p>
          </div>
        </div>
        <div
      ...
      "
        >
          ...
          <div className="faq-content pl-[62px] hidden">
            <p className="text-base text-body-color leading-relaxed py-3">
              Sure! There's a built in menu component!
            </p>
          </div>
        </div>
      </div>
      ...
      "
        >
          ...
          "
            ...
            <div className="w-full">
              <h4 className="text-base sm:text-lg font-semibold text-black">
                Can I add file interactions?
              </h4>
            </div>
          </button>
          <div className="faq-content pl-[62px] hidden">
            <p className="text-base text-body-color leading-relaxed py-3">
              You sure can! There's a built-in File component!
            </p>
          </div>
        </div>
        <div
      ...
      "
        >
          ...
          "
            ...
            <div className="w-full">
              <h4 className="text-base sm:text-lg font-semibold text-black">
                What's the main difference between Pro and Enterprise?
              </h4>
            </div>
          </button>
          <div className="faq-content pl-[62px] hidden">
            <p className="text-base text-body-color leading-relaxed py-3">
              The number of users and the length of Support.
            </p>
          </div>
        </div>
        <div
      ...
      "
        >
          ...
          "
            ...
            <div className="w-full">
              <h4 className="text-base sm:text-lg font-semibold text-black">
                Can we add more tiers?
              </h4>
            </div>
          </button>
          <div className="faq-content pl-[62px] hidden">
            <p className="text-base text-body-color leading-relaxed py-3">
              Sure! That's the intention...you can add as many tiers as you'd
              like.
            </p>
          </div>
        </div>
  ...
  <div className="container px-4">
    <div className="flex flex-wrap">
      <div className="w-full mx-4">
        ...
        "
          >
            Our clients love us. But don't take it from us! Read what they
      ...
      "
        >
          ...
          "
            >
              <img
                src="images/marketing/testimonials/author-01.png"
                alt="author"
              />
            </div>
      ...
      "
        >
          ...
          "
            >
              <img
                src="images/marketing/testimonials/author-02.png"
                alt="author"
              />
            </div>
            <div className="ud-testimonial-meta">
      ...
      "
        >
          ...
          "
            >
              <img
                src="images/marketing/testimonials/author-03.png"
                alt="author"
              />
            </div>
            <div className="ud-testimonial-meta">
        ...
        <div className="wow fadeInUp" data-wow-delay=".2s">
          ...
          <div className="ud-brands-logo flex items-center flex-wrap">
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              ...
              >
                <img
                  src="images/marketing/brands/tailgrids.svg"
                  alt="tailgrids"
            ...
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              ...
              >
                <img
                  src="images/marketing/brands/ayroui.svg"
                  alt="ayroui"
                  className="grayscale hover:filter-none duration-300"
                />
              </a>
            ...
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              ...
              >
                <img
                  src="images/marketing/brands/uideck.svg"
                  alt="uideck"
                  className="grayscale hover:filter-none duration-300"
                />
              </a>
            ...
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              ...
              >
                <img
                  src="images/marketing/brands/graygrids.svg"
                  alt="graygrids"
                  className="grayscale hover:filter-none duration-300"
                />
              </a>
            ...
            <div className="ud-single-logo mr-10 mb-5 max-w-[140px]">
              ...
              >
                <img
                  src="images/marketing/brands/lineicons.svg"
                  alt="lineicons"
                  className="grayscale hover:filter-none duration-300"
                />
              </a>
  ...
  <div className="container">
    <div className="flex flex-wrap -mx-4">
      <div className="w-full px-4">
        ...
        "
          >
            We've got industry leading experts on our team, and they want you
            to be successful.
          </p>
        </div>
      </div>
    ...
    <div className="flex flex-wrap justify-center -mx-4">
      <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
        ...
        "
          >
            <img
              src="images/marketing/team/team-01.png"
              alt="image"
      ...
      <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
        ...
        "
          >
            <img
              src="images/marketing/team/team-02.png"
              alt="image"
              className="w-full rounded-full"
            />
            <span className="absolute top-0 left-0 z-[-1]">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/4 px-4">
        ...
        "
          >
            <img
              src="images/marketing/team/team-03.png"
              alt="image"
              className="w-full rounded-full"
            />
            <span className="absolute top-0 left-0 z-[-1]">
            ...
            <div className="flex max-w-full w-[330px] mb-8">
              ...
              <div>
                ...
                <p className="text-base text-body-color">
                  225 Bush St #200, San Francisco, CA 94104
                </p>
              </div>
            </div>
...
>
        ...
        <div className="w-full mb-10">
          ...
          <ul className="flex flex-wrap items-center">
            ...
            "
              >
                <img
                  src="images/marketing/footer/brands/tailgrids.svg"
                  alt="tailgrids"
                />
              </a>
            </li>
            ...
            "
              >
                <img
                  src="images/marketing/footer/brands/ayroui.svg"
                  alt="ayroui"
                />
              </a>
            </li>
            ...
            "
              >
                <img
                  src="images/marketing/footer/brands/ecommerce-html.svg"
                  alt="ecommerce-html"
                />
              </a>
            </li>
            ...
            "
              >
                <img
                  src="images/marketing/footer/brands/graygrids.svg"
                  alt="graygrids"
                />
              </a>
            </li>
            ...
            "
              >
                <img
                  src="images/marketing/footer/brands/lineicons.svg"
                  alt="lineicons"
                />
              </a>
            </li>
            ...
            "
              >
                <img
                  src="images/marketing/footer/brands/uideck.svg"
                  alt="uideck"
                />
              </a>
            </li>
  ...
  <div>
    <span className="absolute left-0 top-0 z-[-1]">
      <img src="images/marketing/footer/shape-1.svg" alt="" />
    </span>
    <span className="absolute bottom-0 right-0 z-[-1]">
      <img src="images/marketing/footer/shape-3.svg" alt="" />
    </span>
...
export default React.memo(Main, comparisonFn);
